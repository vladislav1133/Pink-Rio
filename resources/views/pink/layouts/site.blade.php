...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" href="{{asset('public/'.env('THEME'))}}/apple-touch-icon-57x.png" />
    <!-- [favicon] end -->

    <!-- CSSs -->
    <link rel="stylesheet" type="text/css" media="all" href="{{asset('public/'.env('THEME'))}}/css/reset.css" /> <!-- RESET STYLESHEET -->
    <link rel="stylesheet" type="text/css" media="all" href="{{asset('public/'.env('THEME'))}}/style.css" /> <!-- MAIN THEME STYLESHEET -->
    <link rel="stylesheet" id="max-width-1024-css" href="{{asset('public/'.env('THEME'))}}/css/max-width-1024.css" type="text/css" media="screen and (max-width: 1240px)" />
    <link rel="stylesheet" id="max-width-768-css" href="{{asset('public/'.env('THEME'))}}/css/max-width-768.css" type="text/css" media="screen and (max-width: 987px)" />
    <link rel="stylesheet" id="max-width-480-css" href="{{asset('public/'.env('THEME'))}}/css/max-width-480.css" type="text/css" media="screen and (max-width: 480px)" />
    <link rel="stylesheet" id="max-width-320-css" href="{{asset('public/'.env('THEME'))}}/css/max-width-320.css" type="text/css" media="screen and (max-width: 320px)" />

    <!-- CSSs Plugin -->
    <link rel="stylesheet" id="thickbox-css" href="{{asset('public/'.env('THEME'))}}/css/thickbox.css" type="text/css" media="all" />
    <link rel="stylesheet" id="styles-minified-css" href="{{asset('public/'.env('THEME'))}}/css/style-minifield.css" type="text/css" media="all" />
    <link rel="stylesheet" id="buttons" href="{{asset('public/'.env('THEME'))}}/css/buttons.css" type="text/css" media="all" />
    <link rel="stylesheet" id="cache-custom-css" href="{{asset('public/'.env('THEME'))}}/css/cache-custom.css" type="text/css" media="all" />
    <link rel="stylesheet" id="custom-css" href="{{asset('public/'.env('THEME'))}}/css/custom.css" type="text/css" media="all" />

    <!-- FONTs -->
    <link rel="stylesheet" id="google-fonts-css" href="http://fonts.googleapis.com/css?family=Oswald%7CDroid+Sans%7CPlayfair+Display%7COpen+Sans+Condensed%3A300%7CRokkitt%7CShadows+Into+Light%7CAbel%7CDamion%7CMontez&amp;ver=3.4.2" type="text/css" media="all" />
    <link rel='stylesheet' href='{{asset('public/'.env('THEME'))}}/css/font-awesome.css' type='text/css' media='all' />

    <!-- JAVASCRIPTs -->
    <script type="text/javascript" src="{{asset('public/'.env('THEME'))}}/js/jquery.js"></script>
    <script type="text/javascript" src="{{asset('public/'.env('THEME'))}}/js/comment-reply.js"></script>
    <script type="text/javascript" src="{{asset('public/'.env('THEME'))}}/js/jquery.quicksand.js"></script>
    <script type="text/javascript" src="{{asset('public/'.env('THEME'))}}/js/jquery.tipsy.js"></script>
    <script type="text/javascript" src="{{asset('public/'.env('THEME'))}}/js/jquery.prettyPhoto.js"></script>
    <script type="text/javascript" src="{{asset('public/'.env('THEME'))}}/js/jquery.cycle.min.js"></script>
    <script type="text/javascript" src="{{asset('public/'.env('THEME'))}}/js/jquery.anythingslider.js"></script>
    <script type="text/javascript" src="{{asset('public/'.env('THEME'))}}/js/jquery.eislideshow.js"></script>
    <script type="text/javascript" src="{{asset('public/'.env('THEME'))}}/js/jquery.easing.js"></script>
    <script type="text/javascript" src="{{asset('public/'.env('THEME'))}}/js/jquery.flexslider-min.js"></script>
    <script type="text/javascript" src="{{asset('public/'.env('THEME'))}}/js/jquery.aw-showcase.js"></script>
    <script type="text/javascript" src="{{asset('public/'.env('THEME'))}}/js/layerslider.kreaturamedia.jquery-min.js"></script>
    <script type="text/javascript" src="{{asset('public/'.env('THEME'))}}/js/shortcodes.js"></script>
    <script type="text/javascript" src="{{asset('public/'.env('THEME'))}}/js/jquery.colorbox-min.js"></script> <!-- nav -->
    <script type="text/javascript" src="{{asset('public/'.env('THEME'))}}/js/jquery.tweetable.js"></script>
        ...
        <div id="header" class="group">
            ...
            <div class="group inner">
                ...
                <div id="logo" class="group">
                    <a href="index.html" title="Pink Rio"><img src="{{asset('public/'.env('THEME'))}}/images/logo.png" title="Pink Rio" alt="Pink Rio" /></a>
                </div>
                <!-- END LOGO -->
            ...
            <div id="yit-widget-area" class="group">
                <div class="yit-widget-content inner group">
                    <div class="widget-first yit-widget widget col1_4 one-fourth col widget-icon-text group">
                        <img class="icon-img" src="{{asset('public/'.env('THEME'))}}/images/icons/cloud.jpg" alt="" />
                        <h3>Great Design</h3>
                    ...
                    <div class="yit-widget widget col1_4 one-fourth col widget-last-post group">
                        <img class="icon-img" src="{{asset('public/'.env('THEME'))}}/images/icons/blog1.png" alt="" />
                        <div>
            ...
            <div class="inner group">
                        ...
                        <div class="section portfolio">
                            ...
                            <div class="hentry work group portfolio-sticky portfolio-full-description">
                                <div class="work-thumbnail">
                                    <a class="thumb"><img src="{{asset('public/'.env('THEME'))}}/images/projects/0081-385x192.jpg" alt="0081" title="0081" /></a>
                                    <div class="work-overlay">
                                        <h3><a href="project.html">Steep This!</a></h3>
                                        <p class="work-overlay-categories"><img src="{{asset('public/'.env('THEME'))}}/images/categories.png" alt="Categories" /> in: <a href="category.html">Brand Identity</a>, <a href="category.html">Web Design</a></p>
                                    </div>
                                </div>
                            ...
                            <div class="portfolio-projects">
                                ...
                                <div class="related_project">
                                    <div class="overlay_a related_img">
                                        <div class="overlay_wrapper">
                                            <img src="{{asset('public/'.env('THEME'))}}/images/projects/0061-175x175.jpg" alt="0061" title="0061" />
                                            <div class="overlay">
                                                <a class="overlay_img" href="{{asset('public/'.env('THEME'))}}/images/projects/0061.jpg" rel="lightbox" title=""></a>
                                ...
                                <div class="related_project">
                                    <div class="overlay_a related_img">
                                        <div class="overlay_wrapper">
                                            <img src="{{asset('public/'.env('THEME'))}}/images/projects/0071-175x175.jpg" alt="0071" title="0071" />
                                            <div class="overlay">
                                                <a class="overlay_img" href="{{asset('public/'.env('THEME'))}}/images/projects/0071.jpg" rel="lightbox" title=""></a>
                                                <a class="overlay_project" href="project.html"></a>
                                ...
                                <div class="related_project">
                                    <div class="overlay_a related_img">
                                        <div class="overlay_wrapper">
                                            <img src="{{asset('public/'.env('THEME'))}}/images/projects/009-175x175.jpg" alt="009" title="009" />
                                            <div class="overlay">
                                                <a class="overlay_img" href="{{asset('public/'.env('THEME'))}}/images/projects/009.jpg" rel="lightbox" title=""></a>
                                                <a class="overlay_project" href="project.html"></a>
                                ...
                                <div class="related_project_last related_project">
                                    <div class="overlay_a related_img">
                                        <div class="overlay_wrapper">
                                            <img src="{{asset('public/'.env('THEME'))}}/images/projects/0011-175x175.jpg" alt="0011" title="0011" />
                                            <div class="overlay">
                                                <a class="overlay_img" href="{{asset('public/'.env('THEME'))}}/images/projects/0011.jpg" rel="lightbox" title=""></a>
                                                <a class="overlay_project" href="project.html"></a>
                ...
                <div class="sidebar group">
                    ...
                    <div class="widget-first widget recent-posts">
                        ...
                        <div class="recent-post group">
                            <div class="hentry-post group">
                                <div class="thumb-img"><img src="{{asset('public/'.env('THEME'))}}/images/articles/001-55x55.png" alt="001" title="001" /></div>
                                <div class="text">
                            ...
                            <div class="hentry-post group">
                                <div class="thumb-img"><img src="{{asset('public/'.env('THEME'))}}/images/articles/003-55x55.jpg" alt="003" title="003" /></div>
                                <div class="text">
                            ...
                            <div class="hentry-post group">
                                <div class="thumb-img"><img src="{{asset('public/'.env('THEME'))}}/images/articles/0037-55x55.jpg" alt="0037" title="0037" /></div>
                                <div class="text">
                    ...
                    <div class="widget-last widget text-image">
                        ...
                        <div class="text-image" style="text-align:left"><img src="{{asset('public/'.env('THEME'))}}/images/callus.gif" alt="Customer support" /></div>
...
<script type="text/javascript" src="{{asset('public/'.env('THEME'))}}/js/jquery.custom.js"></script>
<script type="text/javascript" src="{{asset('public/'.env('THEME'))}}/js/contact.js"></script>
<script type="text/javascript" src="{{asset('public/'.env('THEME'))}}/js/jquery.mobilemenu.js"></script>
