    ...
    <div class="hentry group">
        <div class="section portfolio">
            ...
            @endif
                ...
                <div class="related_project {{($k==count($portfolios)-1)?' related_project_last':''}} ">
                    <div class="overlay_a related_img">
                        <div class="overlay_wrapper">
                            <img src="{{asset('public/'.env('THEME'))}}/images/projects/{{$item->img->mini}}" alt="0061" title="0061" />
                            <div class="overlay">
                                <a class="overlay_img" href="{{asset('public/'.env('THEME'))}}/images/projects/{{$item->img->path}}" rel="lightbox" title=""></a>
